...
HangmanCanvas.prototype.drawLines = function () {
  ...
  var margin=5
  var wLetter=Math.floor(this.widthLetters/this.secretWord.length)
  for(var i=0;i < this.secretWord.length;i++){
    this.ctx.fillRect(25+((wLetter+margin)*i),this.canvas.height-25,wLetter,10);
