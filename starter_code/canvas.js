...
HangmanCanvas.prototype.gameOver = function() {
  this.ctx.drawImage(imageLose, 100, 100, 500, 240);
};

HangmanCanvas.prototype.winner = function() {
  this.ctx.drawImage(imageWin, 100, 100, 800, 618);
};

const imageWin = new Image();
imageWin.src = "../starter_code/images/awesome.png";

const imageLose = new Image();
imageLose.src = "../starter_code/images/gameover.png";
