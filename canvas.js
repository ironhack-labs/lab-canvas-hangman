class HangmanCanvas {
    ...
    drawLines() {
        ...
        for (let i = 0; i < this.secretWord.length; i++) {
            ...
            this.ctx.lineTo(x + 50, 500);
            this.ctx.stroke();
            x += 70
        }
    }

    writeCorrectLetter(int) {
        let x = 200 + int * 75;
        this.ctx.fillText(this.secretWord[int].toUpperCase(), x, 500);
    }

    writeWrongLetter(letter, errorsLeft) {
        let x = 1000 + errorsLeft * -60;
    ...
    gameOver() {
        ...
        gameOverImg.onload = () => this.ctx.drawImage(gameOverImg, 600, 250, 500, 250);
    }
    ...
    winner() {
        ...
        winnerImg.onload = () => this.ctx.drawImage(winnerImg, 600, 250, 700, 300);
    }
}